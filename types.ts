...
// FIX: Using `import * as React from 'react'` to ensure the 'react' module is resolved correctly
// for module augmentation, which can be sensitive to tsconfig settings like `esModuleInterop`.
