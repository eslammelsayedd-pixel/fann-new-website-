                        ...
                        <div className="bg-fann-charcoal-light p-6 rounded-lg space-y-6 self-start">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="company_name" name="company_name" placeholder="Your Company Name" value={formData.company_name} onChange={handleInputChange} required className="w-full bg-fann-charcoal border border-fann-border rounded-md px-3 py-2" />
                                </div>
                                <div>
                                    <label htmlFor="event_name" className="block text-sm font-medium text-fann-light-gray mb-2">Event Name</label>
                                    <input type="text" id="event_name" name="event_name" list="event-options" placeholder="e.g., GITEX Global" value={formData.event_name} onChange={handleInputChange} required className="w-full bg-fann-charcoal border border-fann-border rounded-md px-3 py-2" />
                            ...
                            {(isAnalyzing || suggestionsLoaded) && (
                                <motion.div initial={{opacity: 0, y:-10}} animate={{opacity: 1, y:0}} className="text-xs text-fann-light-gray bg-fann-charcoal p-2 rounded-md flex gap-2 items-center">
                                    {isAnalyzing ? <><Loader2 size={16} className="text-fann-gold flex-shrink-0 animate-spin"/>Analyzing your details to provide personalized suggestions...</> : <><Sparkles size={16} className="text-fann-gold flex-shrink-0"/>We've pre-filled these fields based on our analysis. Please review and adjust for accuracy.</>}
                                </motion.div>
                            )}
                            ...
                            <div className="border-t border-fann-border pt-6 space-y-6">
                                <div>
                                    ...
                                    <input type="range" id="booth_size_sqm" name="booth_size_sqm" min="9" max="500" step="1" value={formData.booth_size_sqm} onChange={handleInputChange} className="w-full h-2 bg-fann-charcoal-light rounded-lg appearance-none cursor-pointer accent-fann-gold" />
                                </div>
                                <div>
                                    <label htmlFor="stand_cost" className="block text-sm font-medium text-fann-light-gray mb-2">Stand Design & Build Cost (AED)</label>
                                    <input type="number" step="1000" id="stand_cost" name="stand_cost" value={formData.stand_cost} onChange={handleInputChange} className="w-full bg-fann-charcoal border border-fann-border rounded-md px-3 py-2" />
                                </div>
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        <label htmlFor="average_deal_size" className="block text-sm font-medium text-fann-light-gray mb-2">Avg. Deal Size (AED)</label>
                                        <input type="number" step="1000" id="average_deal_size" name="average_deal_size" value={formData.average_deal_size} onChange={handleInputChange} className="w-full bg-fann-charcoal border border-fann-border rounded-md px-3 py-2" />
                                    </div>
                                    <div>
                                        ...
                                        <input type="range" id="close_rate" name="close_rate" min="1" max="80" step="1" value={formData.close_rate} onChange={handleInputChange} className="w-full h-2 bg-fann-charcoal-light rounded-lg appearance-none cursor-pointer accent-fann-gold" />
                                    </div>
                                </div>
                            </div>
                        </div>
