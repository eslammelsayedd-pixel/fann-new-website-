...
const ConsultationPage: React.FC = () => {
    return (
        <AnimatedPage>
            ...
            <div className="min-h-screen bg-white dark:bg-fann-teal text-fann-charcoal dark:text-fann-peach pt-32 pb-20">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-5 space-y-8">
                            <div>
                                <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6 text-fann-accent-teal dark:text-fann-gold">
                                    Let's Discuss Your Vision
                                </h1>
                                <p className="text-lg text-fann-teal/80 dark:text-fann-light-gray leading-relaxed">
                            ...
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex items-start gap-4 p-4 bg-fann-peach/50 dark:bg-fann-teal-dark rounded-lg">
                                        <item.icon className="w-6 h-6 text-fann-gold mt-1" />
                                        <div>
                                            <h4 className="font-bold text-fann-teal dark:text-white">{item.title}</h4>
                                            <p className="text-sm text-fann-teal/70 dark:text-fann-light-gray">{item.desc}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>

                            <div className="p-6 border-l-4 border-fann-gold bg-gray-50 dark:bg-black/20">
                                ...
                                <p className="mt-2 font-bold text-xs uppercase tracking-wider">- Marketing Director, FinTech Hive</p>
                            </div>
                        </div>
