            ...
            <div className="py-20 bg-fann-charcoal">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <section className="mt-24 text-center bg-fann-charcoal-light rounded-lg py-16 px-8">
                        ...
                        <div className="mb-8">
                           <img src="https://images.pexels.com/photos/8112165/pexels-photo-8112165.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" alt="3D model of a modern exhibition stand generated by FANN Studio" className="rounded-lg shadow-2xl mx-auto" />
                        </div>
                         <Link to="/fann-studio">
                           <motion.button 
                                whileHover={{ scale: 1.05, boxShadow: "0px 0px 15px rgba(212, 175, 118, 0.5)" }}
