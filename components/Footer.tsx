        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-6 lg:col-span-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="font-semibold mt-2 pt-2 border-t border-fann-border">Office:</li>
              <li>Office 508, Dusseldorf Business Point, Al Barsha 1, Dubai, UAE</li>
              <li className="font-semibold mt-2 pt-2 border-t border-fann-border">Warehouse:</li>
          ...
          <div className="md:col-span-12 lg:col-span-3">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/fannuae/reels/" target="_blank" rel="noopener noreferrer" className="text-fann-light-gray hover:text-fann-gold transition-colors"><Facebook /></a>
              <a href="https://www.instagram.com/fann_uae/" target="_blank" rel="noopener noreferrer" className="text-fann-light-gray hover:text-fann-gold transition-colors"><Instagram /></a>
              <a href="https://ae.linkedin.com/company/fannaedubai" target="_blank" rel="noopener noreferrer" className="text-fann-light-gray hover:text-fann-gold transition-colors"><Linkedin /></a>
              <a href="https://fannae.quora.com/" target="_blank" rel="noopener noreferrer" className="text-fann-light-gray hover:text-fann-gold transition-colors"><QuoraIcon /></a>
            </div>
          </div>
        </div>
