...
const ExitIntentPopup: React.FC = () => {
  ...
  const whatsappUrl = `https://wa.me/${WHATSAPP_PHONE}?text=${encodeURIComponent(MESSAGES.exit_intent)}&utm_source=exit_intent&utm_medium=chat&utm_campaign=whatsapp_exit`;
        ...
        <div className="fixed inset-0 z-[10000] flex items-center justify-center px-4">
          ...
          >
            ...
            <p className="text-gray-300 mb-8 leading-relaxed">
              Get a <span className="text-fann-gold font-bold">FREE 3D design concept</span> for your exhibition stand when you chat with us now.
            </p>
            ...
            >
              ...
              Get My Free 3D Concept →
            </a>
            
            <p className="mt-4 text-xs text-gray-500">
              For new enquiries. No obligation.
            </p>
          </motion.div>
        </div>
      )}
